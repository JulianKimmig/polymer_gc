...
def custom_training_pipeline(
    ...
    **kwargs,
    ...
    conf["epochs"] = 50 # fixed epochs for pretraining
    conf["batch_size"] = 2**6 # fixed batch size for pretraining = 64
    ...
    conf["batch_size"] = 2**4 # fixed batch size for training = 16
